...
Route::group([
    ...
    $router->group(['prefix' => 'api'], function (Router $router) {
        ...
        // delete BorrowRoom
        $router->delete('borrow-rooms/{id}', [BorrowRoomController::class, 'deleteBorrowedRoom']);
        // delete Surat Peminjaman
        $router->delete('borrow-rooms/surat-peminjaman/{id}', [BorrowRoomController::class, 'deleteSuratPeminjaman']);
